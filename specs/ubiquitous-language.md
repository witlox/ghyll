...
| Term | Definition |
|---|---|
| **Role** | A behavioral contract with an exit gate. Four diamond roles have role files in `specs/architecture/roles/`; two synthetic role-ids (`init`, `adversary`) do not. |
