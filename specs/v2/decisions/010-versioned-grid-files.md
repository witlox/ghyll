...
See `gates.md` §2; `specs/direction/components/amendment.md` F-3;
`specs/v2/features/amendment.feature` "Successful atomic write of
v(N+1) with fsync ordering"; `specs/v2/failure-modes.md` FM-12, 13,
14, 15.
